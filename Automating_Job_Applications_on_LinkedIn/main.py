...
driver.get("https://www.linkedin.com/jobs/search/?f_AL=true&geoId=103121230&keywords=python%20developer&location=Philippines")
...
# -------------------------------------------------------------------------------------
#                       PROJECT SOLUTION - APPLYING TO ALL LISTED JOBS
# from selenium import webdriver
